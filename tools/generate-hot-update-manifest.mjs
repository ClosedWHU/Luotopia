...
const tests = {
  ...
  'ai-structured-output-parser': { input: { content: '```json\n{"intent":"create"}\n```' }, expect: { schemaVersion: 1, payload: { intent: 'create_item' } } },
  'whu-email-envelope-parser': { input: { body: { code: 200, data: { unreadCount: 3 } } }, expect: { schemaVersion: 1, success: true, unreadCount: 3 } },
  'medical-report-list-parser': { input: { kind: 'page', html: '<div id="lisId"><div class="f14 mt10 font333 bgw"><div class="p10"><p>血常规</p><p>门诊</p></div><div><a onclick="lisReportDetail(\'adm-token&amp;sign=signed-token\', \'item-token\', \'lab-token\')"><p>2026-07-20 10:00:00</p><span class="weui-cell__ft">报告已出</span></a></div></div></div><div id="risId"></div><script>var lisLoadEnd=!!(\'\');var risLoadEnd=!!(\'1\');</script>' }, expect: { schemaVersion: 1, laboratoryReports: [{ title: '血常规', status: '报告已出', detail: { path: 'lisreportdetail' } }], examinationIsLast: true } },
  ...
  'medical-patient-card-parser': { input: { html: '<div class="cardlistwrap"><div class="cardlist"><p>姓名<span class="font333">张三</span></p><p>常用卡<span class="font333">001</span></p><p>卡类型<span class="font333">普通卡</span></p><input name="cardlist" value="enc123" checked="checked"></div></div>' }, expect: { schemaVersion: 1, cards: [{ patientName: '张三', cardDisplay: '001', cardType: '普通卡', encryptedId: 'enc123', isDefault: true }] } },
  ...
  'medical-invoice-detail-parser': { input: { html: '<p id="prtId">PRT001</p><div class="weui-cell bgw" style="display:block"><div class="weui-cell__bd">就诊人: 张三</div><div class="weui-cell__bd">登记号: REG001</div></div><ul><li id="cat1"><div class="bgtitleyellow">西药 <span class="font-yellow">10.00</span></div></li></ul><div class="postFix"><div class="weui-cell__bd">总计 <span class="font-yellow">10.00</span></div></div>' }, expect: { schemaVersion: 1, patientName: '张三', registrationNumber: 'REG001', totalAmount: '10.00', prtId: 'PRT001', categories: [{ id: 'cat1', title: '西药', amount: '10.00' }] } },
  ...
  'medical-unpaid-invoice-parser': { input: { html: '<div class="f14 mt10 bgw" id ="1390630"><div class="pl20 borderBottom pt10 pb10 font333 f13 ls2"><p class="mt5">就诊科室&nbsp;:&nbsp;<span>本部精神科门诊</span></p><p class="mt5">就诊时间&nbsp;:&nbsp;<span>2026-09-07</span></p></div><div class="borderBottom"><a class="weui-cell weui-cell_access" href="/wehospital/payment/opbillorderlist?admId=b3VvK1cxSGZKQT09"><div class="weui-cell__bd"><p class="fontmoney f16"><span class="f12">￥</span>39.69</p></div><div class="weui-cell__ft font-blue f13">去支付</div></a></div></div>' }, expect: { schemaVersion: 1, invoices: [{ departmentName: '本部精神科门诊', visitedAt: '2026-09-07', amount: '39.69', href: '/wehospital/payment/opbillorderlist?admId=b3VvK1cxSGZKQT09', isPaid: false }] } },
};
